...
const speedOptions = [
    {id: 1, value: "kilometer/hour"},
    {id: 2, value: "meter/second"},
    {id: 3, value: "mile/hour"},
    {id: 4, value: "foot/second"}
]
...
convertBtn.addEventListener('click', (e) => {
    ...
    console.log(main_select[main_select.options.selectedIndex].text)
